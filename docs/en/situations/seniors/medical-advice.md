...
!!! warning "Caution"
    AI tools and WhatsApp forwards are not doctors. They can be useful for general information but must never replace a qualified doctor's advice, especially for medication or serious symptoms.

---

## What could go wrong

- A WhatsApp forward recommends a herbal remedy for diabetes and discourages insulin. A person follows it and is hospitalised.
- An AI chatbot suggests a dosage for a medication that is wrong for an elderly person's weight or kidney condition.
- A message claims a common fruit or spice "cures" a serious illness and the person delays going to a hospital.
- An AI confidently gives a diagnosis that sounds real but is based on a pattern in its training data, not an examination.
- A person shares their medical reports with an AI chatbot, which stores the information on a third-party server.
...
1. Ask your doctor or pharmacist at the next visit — bring the information and ask if it is correct.
2. Check the same information on a government health site: [mohfw.gov.in](https://www.mohfw.gov.in) or [nhp.gov.in](https://www.nhp.gov.in).
3. If a WhatsApp forward says something dramatic ("this cures cancer"), search the claim on a news site you trust. It is almost always false.
...
- [ ] Did you tell a family member if you received alarming health advice on WhatsApp?
- [ ] Did you check an official health site before acting on forwarded advice?
